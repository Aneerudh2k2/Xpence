  ...
  const handleUserApi = async () => {
    try {
      ...
      let userData = await fetch(
        `https://xpencapi.herokuapp.com/users/me?access_token=${access_token}`
      );
  ...
  const handleExpenseApi = async () => {
    try {
      ...
      let expenseData1 = await fetch(
        `https://xpencapi.herokuapp.com/expense/profile_stats?access_token=${access_token}`
      );
      ...
      let expenseData2 = await fetch(
        `https://xpencapi.herokuapp.com/expense/category_count?access_token=${access_token}`
      );
